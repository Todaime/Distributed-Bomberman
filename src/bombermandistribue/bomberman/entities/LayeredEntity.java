...
import bombermandistribue.bomberman.entities.tile.destroyable.DestroyableTile;
...
public class LayeredEntity extends Entity {
	...
	public void render(Screen screen) {
		...
		if (topEntity instanceof Powerup){
			_entities.get(0).render(screen);
			topEntity.render(screen);
		}
		else 
			topEntity.render(screen);
	}
