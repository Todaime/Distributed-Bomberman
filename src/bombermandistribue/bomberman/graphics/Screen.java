...
public class Screen {
	...
	public int[] _pixels;
	private int _transparentColor =0x00000000;
	...
	|--------------------------------------------------------------------------
	 */
	public void drawEndGame(Graphics g, int winner, int playerNum) {
		g.setColor(Color.black);
		g.fillRect(0, 0, getRealWidth(), getRealHeight());

		if (winner == playerNum-1){
			Font font = new Font("Arial", Font.BOLD, 40 * Game.SCALE);
			g.setFont(font);
			...
			drawCenteredString("Defeat", getRealWidth(), getRealHeight(), g);
		}
	}
	...
	public void drawChangeLevel(Graphics g, int level) {
		...
		drawCenteredString("Game Starting", getRealWidth(), getRealHeight(), g);
